...
if (!class_exists('Viral_Times_Welcome')):
    ...
    class Viral_Times_Welcome {
        ...
        public function welcome_notice() {
            ...
            if ('toplevel_page_viral-times-welcome' === $screen->id || (isset($screen->parent_file) && 'plugins.php' === $screen->parent_file && 'update' === $screen->id) || 'theme-install' === $screen->id) {
                return;
            }
            ?>
        ...
        private function upgrade_notice() {
            ...
            if ($screen && 'toplevel_page_viral-times-welcome' === $screen->id) {
                return;
            }
            ?>
            <div class="viral-times-notice notice notice-info">
