 ...
 * @package Viral Times
 */
add_action('widgets_init', 'viral_times_register_category_post_list');

function viral_times_register_category_post_list() {
    register_widget('viral_times_category_post_list');
}

class viral_times_category_post_list extends WP_Widget {

    public function __construct() {
        $widget_ops = array('description' => esc_html__('A widget to display category post with thumbnail.', 'viral-times'));
        parent::__construct('viral_times_category_post_list', '&bull; Viral Times : Post Listing by Category ', $widget_ops);
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'thumbnail_size' => array(
                ...
                'viral_times_widgets_default' => 'viral-times-150x150'
            ),
            'display_date' => array(
            ...
            'layout' => array(
                'viral_times_widgets_name' => 'layout',
                'viral_times_widgets_title' => esc_html__('Layouts', 'viral-times'),
                'viral_times_widgets_field_type' => 'select',
                'viral_times_widgets_field_options' => array(
                    'style1' => esc_html__('Big Thumbnail List', 'viral-times'),
                    'style2' => esc_html__('Small Thumbnail List', 'viral-times'),
                    'style3' => esc_html__('Double Column List', 'viral-times'),
                    'style4' => esc_html__('First Big Thumbnail List', 'viral-times'),
                    'style5' => esc_html__('Big Thumbnail With Title Over Image', 'viral-times')
                ),
                'viral_times_widgets_default' => 'style2'
            ),
            'title_color' => array(
    ...
    public function widget($args, $instance) {
        ...
        $thumbnail_size = isset($instance['thumbnail_size']) ? $instance['thumbnail_size'] : 'viral-times-150x150';
        ...
        <div class="ht-post-listing <?php echo esc_attr($layout); ?>">
            ...
            while ($query->have_posts()):
                ...
                <div class="ht-post-list ht-clearfix">
                    <?php
                    $thumbnail_size = ($layout == 'style4' && $index != 1) ? 'viral-times-150x150' : $thumbnail_size;
                    ?>
