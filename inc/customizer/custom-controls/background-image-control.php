...
/** Background Control */
class Viral_Times_Background_Image_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->button_labels = apply_filters('viral_times_customizer_background_button_labels', $button_labels, $id);

        // Set field labels
        $field_labels = $this->get_field_labels();
        $this->field_labels = apply_filters('viral_times_customizer_background_field_labels', $field_labels, $id);

        // Set background choices
        $background_choices = $this->get_background_choices();
        $this->background_choices = apply_filters('viral_times_customizer_background_choices', $background_choices, $id);
    }
    ...
    public static function get_button_labels() {
        ...
        $button_labels = array(
            'select' => esc_html__('Select Image', 'viral-times'),
            'remove' => esc_html__('Remove', 'viral-times'),
        );
    ...
    public static function get_field_labels() {
        ...
        $field_labels = array(
            'repeat' => esc_html__('Repeat', 'viral-times'),
            'size' => esc_html__('Size', 'viral-times'),
            'position' => esc_html__('Position', 'viral-times'),
            'attachment' => esc_html__('Attachment', 'viral-times'),
            'color' => esc_html__('Background Color', 'viral-times'),
            'overlay' => esc_html__('Overlay Color', 'viral-times')
        );
    ...
    public static function get_background_choices() {
        ...
        $choices = array(
            'repeat' => array(
                'no-repeat' => esc_html__('No Repeat', 'viral-times'),
                'repeat' => esc_html__('Tile', 'viral-times'),
                'repeat-x' => esc_html__('Tile Horizontally', 'viral-times'),
                'repeat-y' => esc_html__('Tile Vertically', 'viral-times')
            ),
            'size' => array(
                'auto' => esc_html__('Default', 'viral-times'),
                'cover' => esc_html__('Cover', 'viral-times'),
                'contain' => esc_html__('Contain', 'viral-times')
            ),
            'position' => array(
                'left-top' => esc_html__('Left Top', 'viral-times'),
                'left-center' => esc_html__('Left Center', 'viral-times'),
                'left-bottom' => esc_html__('Left Bottom', 'viral-times'),
                'right-top' => esc_html__('Right Top', 'viral-times'),
                'right-center' => esc_html__('Right Center', 'viral-times'),
                'right-bottom' => esc_html__('Right Bottom', 'viral-times'),
                'center-top' => esc_html__('Center Top', 'viral-times'),
                'center-center' => esc_html__('Center Center', 'viral-times'),
                'center-bottom' => esc_html__('Center Bottom', 'viral-times')
            ),
            'attachment' => array(
                'fixed' => esc_html__('Fixed', 'viral-times'),
                'scroll' => esc_html__('Scroll', 'viral-times')
            )
        );
