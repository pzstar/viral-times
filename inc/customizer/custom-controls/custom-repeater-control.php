...
/** Repeater Control */
class Viral_Times_Custom_Repeater_Control extends WP_Customize_Control {
                ...
                <div class="ht--custom-repeater-fields">
                        ...
                        <div class="ht--fields ht--type-<?php echo esc_attr($field['type']) . ' ' . esc_attr($class); ?>">
                            ...
                            switch ($field['type']) {
                                ...
                                case 'upload':
                                    ...
                                    esc_html_e('No image selected', 'viral-times');
                                    echo '</div>';
                                    ...
                                    echo '<button type="button" class="button ht--delete-button align-left">' . esc_html__('Remove', 'viral-times') . '</button>';
                                    echo '<button type="button" class="button ht--upload-button alignright">' . esc_html__('Select Image', 'viral-times') . '</button>';
                                ...
                                case 'category':
                                    ...
                                    echo '<option value="-1" ' . selected($new_value, '-1', false) . '>' . esc_html__('Latest Posts', 'viral-times') . '</option>';
                    ...
                    <div class="ht--clearfix ht--custom-repeater-footer">
                        <div class="alignright">
                            <a class="ht--custom-repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'viral-times') ?></a> |
                            <a class="ht--custom-repeater-field-close" href="#close"><?php esc_html_e('Close', 'viral-times') ?></a>
                        </div>
                    </div>
                </div>
            </li>
