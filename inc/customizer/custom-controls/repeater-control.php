...
/** Repeater Control */
class Viral_Times_Repeater_Control extends WP_Customize_Control {
                    ...
                    <div class="ht--repeater-fields">
                        ...
                        <div class="ht--clearfix ht--repeater-footer">
                            <div class="alignright">
                                <a class="ht--repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'viral-times') ?></a> |
                                <a class="ht--repeater-field-close" href="#close"><?php esc_html_e('Close', 'viral-times') ?></a>
                            </div>
                        </div>
                    </div>
                </li>
