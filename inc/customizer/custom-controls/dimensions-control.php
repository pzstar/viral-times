...
/** Dimensions Control */
class Viral_Times_Dimensions_Control extends WP_Customize_Control {
    ...
    public function to_json() {
        ...
        $this->json['title'] = esc_html__('Link values together', 'viral-times');
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'desktop_top' => esc_attr__('Top', 'viral-times'),
            'desktop_right' => esc_attr__('Right', 'viral-times'),
            'desktop_bottom' => esc_attr__('Bottom', 'viral-times'),
            'desktop_left' => esc_attr__('Left', 'viral-times'),
            'tablet_top' => esc_attr__('Top', 'viral-times'),
            'tablet_right' => esc_attr__('Right', 'viral-times'),
            'tablet_bottom' => esc_attr__('Bottom', 'viral-times'),
            'tablet_left' => esc_attr__('Left', 'viral-times'),
            'mobile_top' => esc_attr__('Top', 'viral-times'),
            'mobile_right' => esc_attr__('Right', 'viral-times'),
            'mobile_bottom' => esc_attr__('Bottom', 'viral-times'),
            'mobile_left' => esc_attr__('Left', 'viral-times'),
        );
        if (false === $id) {
