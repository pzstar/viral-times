...
function viral_times_set_bg_color_value($container, $element, $obj) {
...
(function (api) {
    api.controlConstructor['ht--background-image'] = api.Control.extend({
        ready: function () {
            ...
            viral_times_set_bg_color_value(control.container, '.ht--background-image-color input', control.settings['color']);
            viral_times_set_bg_color_value(control.container, '.ht--background-image-overlay input', control.settings['overlay']);
        }
    });
