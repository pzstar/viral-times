...
/** Color Tab Control */
class Viral_Times_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'viral-times'),
            'x' => esc_attr__('X', 'viral-times'),
            'y' => esc_attr__('Y', 'viral-times'),
            'blur' => esc_attr__('Blur', 'viral-times'),
            'spread' => esc_attr__('Spread', 'viral-times'),
            'inset' => esc_attr__('Inset', 'viral-times'),
            'color' => esc_attr__('Color', 'viral-times'),
        );
        if (false === $id) {
