 ...
 * @access public
 */
class Viral_Times_Typography_Control extends WP_Customize_Control {
    ...
    public function __construct($manager, $id, $args = array()) {
        ...
        $this->l10n = wp_parse_args(
            $this->l10n, array(
                'family' => esc_html__('Font Family', 'viral-times'),
                'style' => esc_html__('Font Weight/Style', 'viral-times'),
                'text_transform' => esc_html__('Text Transform', 'viral-times'),
                'text_decoration' => esc_html__('Text Decoration', 'viral-times'),
                'size' => esc_html__('Font Size', 'viral-times'),
                'line_height' => esc_html__('Line Height', 'viral-times'),
                'letter_spacing' => esc_html__('Letter Spacing', 'viral-times'),
                'color' => esc_html__('Font Color', 'viral-times')
            )
        );
    }
    ...
    public function enqueue() {
        wp_enqueue_script('ht--customize-typograhpy-controls', VIRAL_TIMES_CUSTOMIZER_URL . 'custom-controls/typography/js/customize-controls.js', array('jquery'), VIRAL_TIMES_VER, true);
        wp_enqueue_style('ht--customize-typograhpy-controls', VIRAL_TIMES_CUSTOMIZER_URL . 'custom-controls/typography/css/customize-controls.css', array(), VIRAL_TIMES_VER);
    }
        ...
        <ul>
            ...
            <li class="ht--typography-color">
                ...
                <div class="customize-control-content">
                    <input class="ht--color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e('Hex Value', 'viral-times'); ?>" {{{ data.color.link }}} value="{{ data.color.value }}"  />
                </div>
            </li>
            <# } #>
    ...
    public function get_registered_fonts() {
        return viral_times_register_fonts();
    }
    ...
    public function get_font_weight_choices() {
        ...
        return array(
            '400' => esc_html__('Normal', 'viral-times'),
            '400italic' => esc_html__('Normal Italic', 'viral-times'),
            '700' => esc_html__('Bold', 'viral-times'),
            '700italic' => esc_html__('Bold Italic', 'viral-times')
        );
    }
    ...
    public function get_text_decoration_choices() {
        return array(
            ...
            'underline' => esc_html__('Underline', 'viral-times'),
            'line-through' => esc_html__('Line-through', 'viral-times'),
            'overline' => esc_html__('Overline', 'viral-times')
        );
    }
    ...
    public function get_text_transform_choices() {
        return array(
            'none' => esc_html__('None', 'viral-times'),
            'uppercase' => esc_html__('Uppercase', 'viral-times'),
            'lowercase' => esc_html__('Lowercase', 'viral-times'),
            'capitalize' => esc_html__('Capitalize', 'viral-times')
        );
    }
