...
/** Border Control */
class Viral_Times_Border_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'border_width' => esc_attr__('Width', 'viral-times'),
            'border_type' => esc_attr__('Border Type', 'viral-times'),
            'color' => esc_attr__('Border Color', 'viral-times'),
            'top' => esc_attr__('Top', 'viral-times'),
            'right' => esc_attr__('Right', 'viral-times'),
            'bottom' => esc_attr__('Bottom', 'viral-times'),
            'left' => esc_attr__('Left', 'viral-times')
        );
        if (false === $id) {
    ...
    function get_all_border_types() {
        return array(
            '' => esc_attr__('None', 'viral-times'),
            'solid' => esc_attr__('Solid', 'viral-times'),
            'double' => esc_attr__('Double', 'viral-times'),
            'dotted' => esc_attr__('Dotted', 'viral-times'),
            'dashed' => esc_attr__('Dashed', 'viral-times'),
            'groove' => esc_attr__('Groove', 'viral-times')
        );
    }
